[SeLite Commands](https://addons.mozilla.org/en-US/firefox/addon/selite-commands/), one of SeLite AddOns, provides several Selenese commands and related functionality.
